...
export function GameMenu({
  ...
  return (
    <div
      className="absolute inset-0 z-30 flex items-start justify-end pt-16 pr-3 sm:pr-5 animate-fade-in"
      onClick={onClose}
    >
      <div
        className="bg-surface-elevated border border-border rounded-xl shadow-sm py-2 min-w-[200px] animate-scale-in"
