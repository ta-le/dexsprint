  ...
  return (
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
      <DialogContent className="bg-surface-elevated border-border">
        ...
        <DialogDescription className="text-sm text-foreground-muted leading-relaxed">
          A speed-naming challenge for the original 151 Pokémon. Zoom in to see
          detailed info for guessed Pokémon.
        </DialogDescription>
        ...
        <div className="border-t border-border-subtle pt-4">
          <p className="text-xs text-foreground-muted">
            Developed by{" "}
            <span className="text-foreground font-medium">Tuan Anh Le</span>
          </p>
          <a
        ...
        <a
          ...
          className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-lg bg-[#0070ba] hover:bg-[#005ea6] text-white text-sm font-medium transition-colors"
        >
          <svg
            viewBox="0 0 24 24"
